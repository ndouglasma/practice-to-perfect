...
Question.create(body: "Give an example of a goal you reached and tell me how you achieved it.", question_category: behave)
Question.create(body: "Describe a stressful situation at work and how you handled it.", question_category: behave)
Question.create(body: "Give an example of a goal you didn't meet and how you handled it.", question_category: behave)
Question.create(body: "We all make mistakes we wish we could take back. Tell me about a time you wish you’d handled a situation differently with a colleague.", question_category: behave)
Question.create(body: "Describe a time when you had to interact with a difficult client. What was the situation, and how did you handle it? If you haven't been in a client-facing role, tell me about a difficult business partner or fellow work colleague outside of your team.", question_category: behave)
Question.create(body: "Tell me about a time you were under a lot of pressure. What was going on, and how did you get through it?", question_category: behave)
Question.create(body: "Tell me about a time you failed. How did you deal with the situation?", question_category: behave)
Question.create(body: "Tell me about a time you had to be very strategic in order to meet all your top priorities.", question_category: behave)
Question.create(body: "Tell me about a time when you worked on a team based project when a member was not doing their share of the work.", question_category: behave)
